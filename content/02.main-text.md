...
On the other hand, after tuning the learning rate, models fit using stochastic gradient descent tended to perform well at fairly low regularization strengths (10000+ nonzero features in the model), and overfitting was uncommon.
